...
class JoystickPublisher(Node):
    ...
    def __init__(self):
        ...
        self.possible_joysticks = ["sony computer entertainment wireless controller", "thrustmaster t.16000m", "xbox one s controller"]

        # 0: PS4 1: Thrustmaster 2: Xbox One
